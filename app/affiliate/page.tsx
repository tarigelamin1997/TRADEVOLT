...
import { generateAffiliatePDF } from '@/lib/services/affiliate-pdf-generator'
...
export default function AffiliatePage() {
  ...
  const handleDownloadMaterials = async () => {
    try {
      ...
      const pdfBlob = generateAffiliatePDF(referralCode)
      
      // Create download link
      const url = window.URL.createObjectURL(pdfBlob)
      const a = document.createElement('a')
      a.href = url
      a.download = `TradeVolt_Affiliate_Materials_${referralCode}.pdf`
